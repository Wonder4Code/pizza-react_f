            ...
            <div className={'basket'}>
                ...
                <div className={'basket__footer'}>
                    ...
                    <div className={'basket__buttons-wrapper'}>
                        ...
                        <Link className={'basket__button basket__button_pay'}
                              onClick={() => dispatch(clearBasketAction())}
                              to={'/order-success'}>Оплатить сейчас</Link>
                    </div>
                </div>
            </div>
        </div>
